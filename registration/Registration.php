...
<html>
    ...
    <head><title>Registration</title></head>
        ...
        <input type="text" onpaste="return false;" ondrop="return false;" autocomplete="off" name="first_name" placeholder="First name" style =" height:30; width: 200;" class ="form">         
        <input type="text" onpaste="return false;" ondrop="return false;" autocomplete="off" name="last_name" placeholder="Last name" style="margin-top: 10; height:30; width: 200;"class ="form">   
        <input type="password" onpaste="return false;" ondrop="return false;" autocomplete="off" name="password_encrypted" placeholder="Password" style="margin-top: 10;  height:30; width: 200;"class ="form">  
        ...
        <input type="tel" onpaste="return false;" ondrop="return false;" autocomplete="off" name="phone" placeholder="Number: ### ### ####"  pattern="[0-9]{3} [0-9]{3} [0-9]{4}" maxlength="12" style="margin-top: 10;  height:30; width: 200;"class ="form">  
